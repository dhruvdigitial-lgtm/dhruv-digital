    ...
    >
      <div className="text-center px-4 py-20">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          ...
          <button className="rounded-xl bg-cyan-500 px-8 py-4 font-semibold transition hover:bg-cyan-600 hover:scale-105">
            🖨️ Print Order
          </button>

          <button className="rounded-xl border border-cyan-500 px-8 py-4 font-semibold transition hover:bg-cyan-500 hover:scale-105">
            📄 Resume Service
          </button>
