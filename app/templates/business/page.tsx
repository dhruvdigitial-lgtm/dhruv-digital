...
const [selected,setSelected]=useState("Visiting Card");



const templates=Array.from({length:20},(_,i)=>({

code:`DESIGN-${String(i+1).padStart(3,"0")}`
...
<aside className="w-full md:w-72 bg-gray-950 border border-gray-800 p-6 min-h-screen">
